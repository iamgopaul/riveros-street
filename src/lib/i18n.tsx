...
const EN: Dict = {
  ...
  "find.openNow": "Open now",
  "find.closed": "Closed",
  "find.until": "until",
  "find.opens": "opens",
  "find.today": "Today",
  "find.pickupTitle": "How pickup works",
  "find.step1.t": "Order on WhatsApp",
  "find.step1.b": "Build your order here and send it straight to the truck.",
  "find.step2.t": "We confirm & cook",
  "find.step2.b": "We reply with a pickup time and cook it fresh.",
  "find.step3.t": "Grab it at the window",
  "find.step3.b": "Give your name, pay at the window, and enjoy.",

  // order
  "order.eyebrow": "Order to Go",
  "order.title.a": "Pickup at the",
  "order.title.b": "window.",
  "order.lede": "Build your order, then send it straight to the truck on WhatsApp. We'll have it hot at the window.",
  ...
  "order.notes": "Notes",
  "order.notesPlaceholder": "No onions, extra sauce…",
  "order.required": "Required",
  "order.optional": "Optional",
  "order.pickUpTo": "Pick up to {n}",
  "order.increase": "Increase quantity",
  "order.decrease": "Decrease quantity",
  "order.wa.header": "Rivero's Street — Pickup order",
  "order.ref": "Order ref",
  ...
  "checkout.pickup": "Pickup time",
  "checkout.notesPlaceholder": "Anything else for the kitchen?",
  "checkout.send": "Send order on WhatsApp",
  "checkout.back": "Back to cart",
  "checkout.payNote": "Pay now by card, or order on WhatsApp and pay at the window.",
  "checkout.total": "Total",
  "checkout.done.title": "Order sent!",
  "checkout.done.body": "We received your order on WhatsApp and will confirm shortly. Show this reference at the window.",
  "checkout.done.close": "Done",

  // payment (Square)
  "pay.title": "Payment",
  "pay.payNow": "Pay now with card",
  "pay.card": "Card details",
  "pay.pay": "Pay",
  "pay.processing": "Processing…",
  "pay.secure": "Secured by Square. Your card is encrypted and never touches our servers.",
  "pay.notConfigured": "Card payment isn't set up yet — order on WhatsApp and pay at the window.",
  "pay.loadError": "Couldn't load the payment form. Try again or order on WhatsApp.",
  "pay.cardError": "Please check your card details.",
  "pay.declined": "Payment didn't go through. Try another card.",
  "pay.done.body": "Payment received — your order is confirmed. Show this reference at the window.",
...
const ES: Dict = {
  ...
  "find.openNow": "Abierto ahora",
  "find.closed": "Cerrado",
  "find.until": "hasta",
  "find.opens": "abre",
  "find.today": "Hoy",
  "find.pickupTitle": "Cómo recoger tu pedido",
  "find.step1.t": "Pide por WhatsApp",
  "find.step1.b": "Arma tu pedido aquí y envíalo directo al camión.",
  "find.step2.t": "Confirmamos y cocinamos",
  "find.step2.b": "Respondemos con la hora y lo cocinamos al momento.",
  "find.step3.t": "Recoge en la ventana",
  "find.step3.b": "Da tu nombre, paga en la ventana y disfruta.",

  // order
  "order.eyebrow": "Pedir Para Llevar",
  "order.title.a": "Recoger en la",
  "order.title.b": "ventana.",
  "order.lede": "Arma tu pedido y envíalo directo al camión por WhatsApp. Lo tendremos calientito en la ventana.",
  "order.pickupOnly": "Solo para llevar",
  "order.add": "Agregar",
  "order.customize": "Personalizar",
  "order.back": "Volver al Menú",
  "order.viewOrder": "Ver pedido",
  "order.subtotal": "Subtotal",
  "order.notes": "Notas",
  "order.notesPlaceholder": "Sin cebolla, salsa extra…",
  "order.required": "Obligatorio",
  "order.optional": "Opcional",
  "order.pickUpTo": "Elige hasta {n}",
  "order.increase": "Aumentar cantidad",
  "order.decrease": "Disminuir cantidad",
  "order.wa.header": "Rivero's Street — Pedido para llevar",
  ...
  "checkout.pickup": "Hora de recogida",
  "checkout.notesPlaceholder": "¿Algo más para la cocina?",
  "checkout.send": "Enviar pedido por WhatsApp",
  "checkout.back": "Volver al carrito",
  "checkout.payNote": "Paga ahora con tarjeta, o pide por WhatsApp y paga en la ventana.",
  "checkout.total": "Total",
  "checkout.done.title": "¡Pedido enviado!",
  "checkout.done.body": "Recibimos tu pedido por WhatsApp y lo confirmaremos pronto. Muestra esta referencia en la ventana.",
  "checkout.done.close": "Listo",

  // payment (Square)
  "pay.title": "Pago",
  "pay.payNow": "Pagar con tarjeta",
  "pay.card": "Datos de la tarjeta",
  "pay.pay": "Pagar",
  "pay.processing": "Procesando…",
  "pay.secure": "Pago seguro con Square. Tu tarjeta va cifrada y nunca pasa por nuestros servidores.",
  "pay.notConfigured": "El pago con tarjeta aún no está configurado — pide por WhatsApp y paga en la ventana.",
  "pay.loadError": "No se pudo cargar el formulario de pago. Inténtalo de nuevo o pide por WhatsApp.",
  "pay.cardError": "Revisa los datos de tu tarjeta.",
  "pay.declined": "El pago no se completó. Prueba con otra tarjeta.",
  "pay.done.body": "Pago recibido — tu pedido está confirmado. Muestra esta referencia en la ventana.",
